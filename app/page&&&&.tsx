...
const Home = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (results.length > 0) {
        ...
        setOtherResults(results.slice(1, 5)); // Limite à 4 autres résultats
  ...
  return (
    <ToastProvider>
      <div className={`min-h-screen bg-gradient-to-b ${darkMode ? 'from-gray-900 to-gray-800' : 'from-blue-100 to-purple-100'} text-gray-900 dark:text-white p-4 transition-colors duration-300 ${isModalOpen ? 'blur-sm' : ''}`}>
